...
1. Configure your auth token. It is recommended to do this via the `HUGO_PARAMS_BGG_AUTHTOKEN` environment variable, but it can also be done via the config:
    ...
    The auth token should be considered a secret and should not be commit to source control!
